...
<asp:Content ID="registerHandlingEventTitle" ContentPlaceHolderID="TitleContent" runat="server">
	Book new cargo
</asp:Content>

<asp:Content ID="registerHandlingEventContent" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Register new handling event</h2>
    <p>
    ...
    <% using (Html.BeginForm()) { %>
        <div>
            <fieldset>
                ...
                <p>
                    <label for="trackingId">Cargo tracking id:</label>
