...
namespace DDDSample.Domain.Persistence.NHibernate
{
   public static class SampleVoyages
   {
      ...
      public static readonly Voyage.Voyage V300 =
         Voyage("V300",
      ...
      public static readonly Voyage.Voyage V400 =
         Voyage("V400",
      ...
      private static Voyage.Voyage Voyage(string number, params CarrierMovement[] movements)
      {
          return new Voyage.Voyage(new VoyageNumber(number), new Schedule(movements.ToList()));
      }
